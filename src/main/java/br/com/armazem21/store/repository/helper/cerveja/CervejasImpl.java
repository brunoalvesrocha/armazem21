...
public class CervejasImpl implements CervejasQueries {
	...
	public List<CervejaDTO> porSkuOuNome(String skuOuNome) {
		String jpql = "select new br.com.armazem21.store.dto.CervejaDTO(codigo, sku, nome, origem, valor, foto) "
	...
	public ValorItensEstoque valorItensEstoque() {
		String query = "select new br.com.armazem21.store.dto.ValorItensEstoque(sum(valor * quantidadeEstoque), sum(quantidadeEstoque)) from Cerveja";
