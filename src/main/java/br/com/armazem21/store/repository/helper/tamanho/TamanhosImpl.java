...
public class TamanhosImpl implements TamanhosQueries {
	...
	public Page<Tamanho> filtrar(TamanhoFilter filtro, Pageable pageable) {
		Criteria criteria = manager.unwrap(Session.class).createCriteria(Tamanho.class);
	...
	private Long total(TamanhoFilter filtro) {
		Criteria criteria = manager.unwrap(Session.class).createCriteria(Tamanho.class);
		adicionarFiltro(filtro, criteria);
	...
	private void adicionarFiltro(TamanhoFilter filtro, Criteria criteria) {
		if (filtro != null) {
