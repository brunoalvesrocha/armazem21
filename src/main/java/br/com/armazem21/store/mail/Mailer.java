package br.com.armazem21.store.mail;
...
public class Mailer {
	...
	public void enviar(Venda venda) {
		...
		try {
			...
			helper.setFrom("contato@armazem21store.com.br");
			helper.setTo(venda.getCliente().getEmail());
			helper.setSubject(String.format("Armazem21 - Venda nº %d", venda.getCodigo()));
			helper.setText(email, true);
			
			helper.addInline("logo", new ClassPathResource("static/images/logo-armazem.jpg"));
			
			if (adicionarMockCerveja) {
				helper.addInline("mockCerveja", new ClassPathResource("static/images/produto-vazio.jpg"));
			}
